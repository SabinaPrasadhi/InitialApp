...
@Component({
  selector: 'app-view-sub-page',
  templateUrl: './view-sub-page.component.html',
  styleUrls: ['./view-sub-page.component.css'],
  template: `
  <h1>{{title}}</h1>
...
export class ViewSubPageComponent {
  title = 'Details of the Child';

 childFacts = [
  new Child(1,'Pinky','2018.01.24','9.45','Female',0.25,'BCG','Borella','Colombo','Colombo','Colombo','Borella','Borella-North',
  'No.354','Cota Road','Borella','008','own',1)
